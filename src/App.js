...
import SpartanImg2 from './componentFiles/Halo/Halo_Api/SpartanImg/Gamertag2'
// import Loadout1 from './componentFiles/LoadoutNames/Loadout_1'
import Clock from './componentFiles/Clock'
    ...
    return (
      <div className="App">
        ...
        <div className='bottom'>
          ...
          <div className='spartanDisplay'> <SpartanImg2/> </div>
          <div className='stats'></div>
        </div>
        <div className='spacer'><Clock/></div>
      </div>
    );
  }
}
